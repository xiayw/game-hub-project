...
import { RequiredBy, DirectionProperty, CommonProperties, Rect, Size, Point, PropTypes, NormalizeProps } from '@zag-js/types';
import * as _zag_js_core from '@zag-js/core';
import { Service, EventObject, Machine } from '@zag-js/core';

declare const anatomy: _zag_js_anatomy.AnatomyInstance<"root" | "viewport" | "image" | "selection" | "handle" | "grid">;
...
declare const machine: _zag_js_core.Machine<ImageCropperSchema>;
...
export { type ImageCropperApi as Api, type BoundingRect, type CropChangeDetails, type CropData, type ElementIds, type FlipChangeDetails, type FlipState, type GetCroppedImageOptions, type GridProps, type HandlePosition, type HandleProps, type IntlTranslations, type ImageCropperMachine as Machine, type PreviewDescriptionDetails, type ImageCropperProps as Props, type RotationChangeDetails, type SelectionLabelDetails, type SelectionValueTextDetails, type ImageCropperService as Service, type ZoomChangeDetails, anatomy, connect, handles, machine, props, splitProps };
