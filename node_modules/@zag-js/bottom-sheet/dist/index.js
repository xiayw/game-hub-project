    ...
    getContentProps(props2 = { draggable: true }) {
      return normalize.element({
        ...
        style: {
          ...
          "--bottom-sheet-translate": utils.toPx(translate),
  ...
  implementations: {
    ...
    effects: {
      ...
      trackContentHeight({ context, scope }) {
        ...
        updateHeight();
        return domQuery.resizeObserverBorderBox.observe(contentEl, updateHeight);
      },
